...
# Monitoring u1: clear && ps -ef | grep unarchive && echo '-s1-' && tail "$HOME"/my_env/s1/nohup.out && echo '-s2-' && tail "$HOME"/my_env/s2/nohup.out && echo '-s3-' && tail "$HOME"/my_env/s3/nohup.out && echo '-s4-' && tail "$HOME"/my_env/s4/nohup.out
